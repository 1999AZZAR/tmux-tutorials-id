# Peta Pembelajaran Tmux

Kurikulum komprehensif dari arsitektur dasar hingga otomatisasi tingkat profesional.

## Fase 1: Dasar (Beginner)
...
1. [Copy Mode dan Navigasi Buffer](modules/02-intermediate/03-copy-mode.md)
2. [Sesi dan Persistensi](modules/02-intermediate/01-sessions-persistence.md)
